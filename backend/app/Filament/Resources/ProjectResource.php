    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                ...
                FileUpload::make('image1')->image()->maxFiles(1)->maxSize(1024)->required(),
                FileUpload::make('image2')->image()->maxFiles(1)->maxSize(1024)->required(),
                FileUpload::make('image3')->image()->maxFiles(1)->maxSize(1024)->required(),
